...
int a64_usbhost_initialize(void)
{
  ...
  // Init LTE Modem moved to pinephone_modem_init in
  // https://github.com/lupyuen2/wip-pinephone-nuttx/blob/usb/boards/arm64/a64/pinephone/src/pinephone_bringup.c
